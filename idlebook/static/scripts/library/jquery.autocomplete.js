...
(function($) {
    ...
    $.Autocompleter = function($elem, options) {
        ...
        $elem.keydown(function(e) {
            ...
            switch(self.lastKeyPressed_) {
                ...
                case 8: // backspace/delete +Sean Ren
                    self.activateNow();
                break;
        ...
        /**
         * If $elem is empty, finsih immediately +Sean Ren
         */
        $elem.keyup(function() {
            if ($elem.val() == '') {
                self.finish();
    ...
    $.Autocompleter.prototype.parseRemoteJSON = function(remoteData) {
        return remoteData;
    //  return $.parseJSON(remoteData); in Django, remoteData is already JSON. no need to parse. +Sean Ren
    };
    ...
    $.Autocompleter.prototype.showResults = function(results, filter) {
        ...
        // Add additional result row to list +Sean Ren
        if ($.isFunction(this.options.additionalResult)) {
            var query = this.dom.$elem.val();
            $li = $('<li>' + this.options.additionalResult(query) + '</li>');
            $li.data('value', query);
        ...
        // Allow custom result width +Sean Ren
        if (this.options.resultWidth == null) {
            this.dom.$results.width(this.dom.$elem.outerWidth() - extraWidth);
        } else {
            this.dom.$results.width(this.options.resultWidth - extraWidth);
        }
    ...
    $.fn.autocomplete.defaults = {
        ...
        resultWidth: null, // +Sean Ren
        additionalResult: null, // +Sean Ren
    };
